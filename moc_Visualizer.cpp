...
static const char qt_meta_stringdata_Visualizer[] = {
    "Visualizer\0\0xmin,ymin,xmax,ymax\0"
    "newRegionChoosed(double,double,double,double)\0"
    ",,,\0resizeArea(double,double,double,double)\0"
    "zoomIn()\0zoomOut()\0"
};
...
void Visualizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newRegionChoosed((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;
        case 1: _t->resizeArea((*reinterpret_cast< const double(*)>(_a[1])),(*reinterpret_cast< const double(*)>(_a[2])),(*reinterpret_cast< const double(*)>(_a[3])),(*reinterpret_cast< const double(*)>(_a[4]))); break;
...
// SIGNAL 0
void Visualizer::newRegionChoosed(double _t1, double _t2, double _t3, double _t4)
{
